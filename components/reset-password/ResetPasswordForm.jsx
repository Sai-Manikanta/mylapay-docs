...
import GeneratePasswordSuccessModel from './ResetPasswordSuccessModel';
            ...
            <div className="relative z-10 bg-white rounded-xl border border-gray/20 m-4 sm:m-0">
                <Formik
                    ...
                    onSubmit={async (values, { setSubmitting, setErrors }) => {
                        try {
                            const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/auth/user/reset-password/${token}`, {

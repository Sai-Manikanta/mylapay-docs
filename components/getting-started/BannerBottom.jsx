            ...
            <div className="bg-white">
                <div className="wrapper md:grid grid-cols-2 items-center py-16 ">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="px-4 sm:px-0 mt-8 text-center md:text-left text-lg font-light lg:w-[90%] text-black">
                        ...
                        <p className="px-4 sm:px-0 mt-4 mb-4 text-center md:text-left text-lg font-light lg:w-[90%] text-black">

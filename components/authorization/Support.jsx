function Support() {
            ...
            <div className='bg-[#fff] '>
                <div className="wrapper xxl:mx-[-30px]">
                    <div className="mx-auto py-20 px-4 sm:px-0">
                        ...
                        <div className=" mx-auto bg-bluedark py-12 px-5 rounded-xl">
    ...
    return (
        <section className="py-20 bg-white my-20">
            <div>
                <div className=" mx-auto bg-bluedark py-12 px-5 rounded-xl">
                    <div className="grid gap-5 text-center lg:grid-cols-2 xl:grid-cols-2">
                        <div>
                            <div
                                className="text-xl leading-[40px] lg:text-3xl mt-3 text-white aos-init aos-animate"
                            >
                        ...
                        <div className="item-right">
                            <a href="/contact">
                                <button className="mb-5 mr-1 sm:mr-5 xl:mr-5 xl:my-2 font-semibold px-5 w-52 text-white text-sm rounded-md bg-bluelight hover:before:bg-white hover:text-black relative h-[50px]  overflow-hidden px-3  shadow-2xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:transition-all before:duration-500 hover:text-white hover:before:left-0 hover:before:w-full uppercase">
                                    <span className="relative z-10"> Integrate with us </span>
                                </button>
                            </a>
                            <button
                                className="my-2 font-semibold px-5 w-52 mr-1 lg:mx-0 text-white text-sm rounded-md bg-bluelight hover:before:bg-white hover:text-black relative h-[50px] overflow-hidden px-3 shadow-2xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:transition-all before:duration-500 hover:text-white hover:before:left-0 hover:before:w-full uppercase aos-init aos-animate"
